...
#+begin_src emacs-lisp
  (use-package zenburn-theme
    ...
    (setq zenburn-override-colors-alist
	  '(("zenburn-bg" . "#494949") ; Make background lighter.
	    ("zenburn-fg"  . "#CBB390") ; Make main text light gold. Color borrowed from Jon Blow.
	    ;; Set original orange and yellow to blue since they conflict
	    ;; with the main text.
	    ("zenburn-orange" . "#7CB8BB")
