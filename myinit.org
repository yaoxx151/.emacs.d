...
keybindings. Emacs default keybindings are too long:
| Key         | Command                          |
|-------------+----------------------------------|
| C-s         | Save                             |
| C-o         | Switch window                    |
...
#+begin_src emacs-lisp
  ...
  ;; newly splitted window. And simplify key.
...
#+begin_src emacs-lisp
  ...
  (bind-key* "C-x 0" (lambda ()
			  (interactive)
			  (message "Use C-0, dude.")))
  (bind-key* "C-x 1" (lambda ()
			  (interactive)
			  (message "Use C-1, dude.")))
  (bind-key* "C-x 2" (lambda ()
			  (interactive)
			  (message "Use C-2, dude.")))
  (bind-key* "C-x 3" (lambda ()
			  (interactive)
			  (message "Use C-3, dude.")))
