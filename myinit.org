...
#+begin_src emacs-lisp
  (use-package ace-window
    :ensure t
    :bind
    ;; Overwrite normal `other-window`, use `C-o` for it.
    ("C-x o" . ace-window))
#+end_src
* Avy
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package zenburn-theme
    ...
    ;; Highlight current buffer through mode-line color.
    (set-face-attribute 'mode-line-buffer-id nil :foreground "#CC9999" :underline)
    (set-face-attribute 'mode-line-inactive nil :foreground "gray40")
